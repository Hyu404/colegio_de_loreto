export type FacultySection = 'Overview' | 'My Classes' | 'Students' | 'Gradebook' | 'Schedule' | 'Announcements' | 'Help & Support'
...
export const facultyNavItems: { label: FacultySection; icon: string }[] = [
  { label: 'Overview', icon: 'LayoutDashboard' }, { label: 'My Classes', icon: 'BookOpen' }, { label: 'Students', icon: 'Users' }, { label: 'Gradebook', icon: 'ClipboardCheck' }, { label: 'Schedule', icon: 'CalendarDays' }, { label: 'Announcements', icon: 'Megaphone' }, { label: 'Help & Support', icon: 'CircleHelp' },
]
